    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        <div className="brand-card p-8 prose prose-invert">
          <p className="text-cyan-300 text-xs font-mono-hud tracking-[0.2em] uppercase mb-2 not-prose">
            Legal · Privacy
          </p>
          ...
          <h2>Cookies</h2>
          <p>
            We use first-party cookies for authentication and CSRF protection only. Analytics are loaded
