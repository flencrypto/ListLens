    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <main className="flex items-center justify-center px-6 py-20">
        <div className="brand-card p-10 max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-[color:var(--brand-text-strong)] mb-2 flex items-center justify-center gap-2">
            <WifiOff className="h-6 w-6 text-cyan-400" />
            You&apos;re offline
          </h1>
          <div className="hud-divider mx-auto my-4 max-w-[120px]" />
          <p className="text-sm text-[color:var(--brand-text-muted)] mb-6">
