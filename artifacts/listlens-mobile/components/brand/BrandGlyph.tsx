 ...
 * artwork. Used as a quiet brand cue at the bottom of the splash and as a
 * footer glyph. Pure SVG.
 */
export function BrandGlyph({ size = 36 }: Props) {
  ...
  return (
    <Svg viewBox="0 0 64 64" width={size} height={size}>
      ...
      <Path
        ...
        opacity={0.55}
      />
      <G transform="translate(20 18)" stroke={stroke} strokeWidth={1.6} fill="none" strokeLinecap="round" strokeLinejoin="round">
